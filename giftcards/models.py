...
class DigitalGiftCard(BaseGiftCard):
    ...
    recipient = models.ForeignKey(
        "accounts.CustomUser", on_delete=models.CASCADE, related_name="digital_recipient"
    )
    giver = models.ForeignKey(
        "accounts.CustomUser", on_delete=models.CASCADE, related_name="digital_giver"
    )
...
class PhysicalGiftCard(BaseGiftCard):
    ...
    card_type = models.ForeignKey(GiftCardType, on_delete=models.CASCADE)
    recipient = models.ForeignKey(
        "accounts.CustomUser", on_delete=models.CASCADE, related_name="physical_recipient"
    )
    giver = models.ForeignKey(
        "accounts.CustomUser", on_delete=models.CASCADE, related_name="physical_giver"
    )
